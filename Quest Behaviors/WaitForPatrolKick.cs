...
namespace Styx.Bot.Quest_Behaviors.DeathknightStart.WaitForPatrol
{
    ...
    public class WaitForPatrol : CustomForcedBehavior
    {
        ...
        public override string      SubversionId { get { return ("$Id: WaitForPatrol.cs 211 2011-11-10 08:00:00Z chinajade $"); } }
        public override string      SubversionRevision { get { return ("$Revision: 211 $"); } }
